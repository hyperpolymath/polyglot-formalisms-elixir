...
[arabic]
. Navigate to
https://github.com/hyperpolymath/polyglot-formalisms-elixir/security/advisories/new[Report
a Vulnerability]
...
* This repository (`+hyperpolymath/polyglot-formalisms-elixir+`) and all
its code
...
https://github.com/hyperpolymath/polyglot-formalisms-elixir/security/advisories[Security
Advisories]
...
* https://github.com/hyperpolymath/polyglot-formalisms-elixir/security/advisories/new[Security
Reporting]
* https://github.com/hyperpolymath/polyglot-formalisms-elixir/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/polyglot-formalisms-elixir/discussions[GitHub
Discussions]
...
_Thank you for helping keep PolyglotFormalisms.Elixir and its users
safe._ 🛡️
