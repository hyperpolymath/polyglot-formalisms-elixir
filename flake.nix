{
  description = "polyglot-formalisms-elixir - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 polyglot-formalisms-elixir development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          pname = "polyglot-formalisms-elixir";
          version = "0.1.0";
          src = ./.;
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P polyglot-formalisms-elixir.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/polyglot-formalisms-elixir $out/bin/  # Rust
            # cp bin/polyglot-formalisms-elixir $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/polyglot-formalisms-elixir";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-polyglot-formalisms-elixir" {
