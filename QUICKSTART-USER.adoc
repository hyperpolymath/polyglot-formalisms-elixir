...
// Replace polyglot-formalisms-elixir, Polyglot Formalisms Elixir — See README.adoc for details., just run, Polyglot Formalisms Elixir started successfully. with actuals
= polyglot-formalisms-elixir — Quick Start for Users
:toc:
:toclevels: 2

== What is polyglot-formalisms-elixir?

Polyglot Formalisms Elixir — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./polyglot-formalisms-elixir-portable
----
...
[source]
----
Polyglot Formalisms Elixir started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/polyglot-formalisms-elixir/wiki
