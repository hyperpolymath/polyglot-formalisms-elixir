...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/polyglot-formalisms-elixir/security/advisories/new)
...
- This repository (`hyperpolymath/polyglot-formalisms-elixir`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/polyglot-formalisms-elixir/security/advisories)
...
When using PolyglotFormalisms.Elixir, we recommend:
...
- [Security Reporting](https://github.com/hyperpolymath/polyglot-formalisms-elixir/security/advisories/new)
- [Security Advisories](https://github.com/hyperpolymath/polyglot-formalisms-elixir/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/polyglot-formalisms-elixir/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/polyglot-formalisms-elixir/discussions) |
...
*Thank you for helping keep PolyglotFormalisms.Elixir and its users safe.* 🛡️
