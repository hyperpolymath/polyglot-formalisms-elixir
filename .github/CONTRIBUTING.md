...
git clone
<https://github.com/hyperpolymath/polyglot_formalisms_elixir.git> cd
polyglot_formalisms_elixir
...
toolbox create polyglot_formalisms_elixir-dev toolbox enter
polyglot_formalisms_elixir-dev \# Install dependencies manually
...
polyglot_formalisms_elixir/ ├── src/ \# Source code (Perimeter 1-2) ├──
...
Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/polyglot_formalisms_elixir/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/polyglot_formalisms_elixir/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/polyglot_formalisms_elixir/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/polyglot_formalisms_elixir/labels/perimeter-3) — Community sandbox scope
