...
# Justfile for polyglot-formalisms-elixir
...
doctor:
    @echo "Running diagnostics for polyglot-formalisms-elixir..."
...
tour:
    @echo "=== polyglot-formalisms-elixir Tour ==="
    @echo ""
...
help-me:
    @echo "=== polyglot-formalisms-elixir Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/polyglot-formalisms-elixir/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: polyglot-formalisms-elixir"
